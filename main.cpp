...
int main() {
    ...
    back = imread(input[1]);
        if (front.empty() == true) {
            ...
            //find contours - to find biggest (most times licence is the biggest)
            ...
            while(itc!=contours_canny.end()) {
                ...
                //check if Rotated rectange bounding contour fill to licence
            ...
            //now we have vector (probably ansisting of one element) of rectangles
            ...
            //Get rotation matrix of our driving licence
            ...
            //resize result
            Mat resultResized;
            //resized to licence sizes (licence is 54mm x 86mm)
            ...
            // this is jus for me , to see contours
            ...
            //write how many contours (characters) detected
